...
var TimerController = require("./public/controllers/Timer")

router.get("/", function (req, res) {
    res.render("index");
});

router.post("/insert-all-timer", jsonParser, function (req, res) {
    console.log(req.body);
    TimerController.insertManyTimer(req.body);
})

// use this if feature delete one by one is already done
router.post("/insert-timer", jsonParser, function (req, res) {
    console.log(req.body);
    TimerController.insertTimer(req.body);
})
...
//         //         }
//         //     }))
//         res.send(TimerController.getAllTimer)
//     }
//     else {
//         waitFor(_ => flag === true)
